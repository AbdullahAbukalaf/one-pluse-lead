...
@section('title','Markets Banner')

@section('content')
<div class="container-fluid">
    <h4 class="mb-3">Markets Banner</h4>


    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.markets.banner.update') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        @if(!empty($item?->image))
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $item->image) }}" alt="Banner" style="max-width: 240px; border-radius: 8px;">
                            </div>
                        @endif
                    </div>
