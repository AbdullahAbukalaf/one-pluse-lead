...
@section('content')
    <div class="container-fluid">
        <h4 class="mb-3">Add Distributor</h4>

        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('admin.where-to-find-us.distributors.store') }}"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="country_en" class="form-control" value="{{ old('country_en') }}">
                            @error('country_en')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="country_ar" class="form-control" value="{{ old('country_ar') }}">
                            @error('country_ar')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="district_en" class="form-control" value="{{ old('district_en') }}">
                            @error('district_en')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="district_ar" class="form-control" value="{{ old('district_ar') }}">
                            @error('district_ar')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('admin.where-to-find-us.distributors.index') }}"
