...
<div class="container-fluid">
    <h4 class="mb-3">Contact Us - Hero Section</h4>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.contact-hero.update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
...
<div class="mb-3">
  ...
  @if(!empty($item->background_image))
    <div class="mt-2">
        <img src="{{ asset('storage/' . $item->background_image) }}" alt="" style="max-height:120px">
    </div>
  @endif
</div>
