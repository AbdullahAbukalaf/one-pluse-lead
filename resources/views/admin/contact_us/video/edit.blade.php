...
@section('title','Contact Us - Video Section')

@section('content')
<div class="container-fluid">
    <h4 class="mb-3">Contact Us - Video Section</h4>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.contact-video.update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
