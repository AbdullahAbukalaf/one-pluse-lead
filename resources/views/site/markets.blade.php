    ...
    <section id="products" class="service_section section_space_lg">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service_item bg-black d-flex justify-content-center align-items-center text-center">
                        <div class="item_icon">
                            <svg width="25" height="52" viewBox="0 0 25 52" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M14.521 20.2881L11.6342 36.9322H3.06641L7.94341 20.2881H14.521Z" fill="#d16527" />
                        ...
                        <div class="item_icon">
                            <svg width="36" height="53" viewBox="0 0 36 53" fill="none"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="#d16527" />
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M5.28809 3.65498H14.5848V0H5.28809V3.65498Z" fill="#d16527" />
                                <path fill-rule="evenodd" clip-rule="evenodd"
