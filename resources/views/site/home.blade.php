        ...
        <div class="service_split_wrapper">
            <div class="service_split_item">
                <div class="item_image">
                    <img src="{{ asset('UI/Site/images/services/service_img_1.jpg') }}" alt="ProMotors - Service Image">
                </div>
            ...
            <div class="service_split_item">
                <div class="item_image">
                    <img src="{{ asset('UI/Site/images/services/service_details_image_2.jpg') }}" alt="ProMotors - Service Image">
                </div>
                <div class="item_content">
                    <div class="section_heading">
                        <div class="outline_text">About Us</div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service_item">
                        <div class="item_icon">
                            <svg width="58" height="21" viewBox="0 0 58 21" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
